...
public class Grabbable : MonoBehaviour {
       ...
       // [HideInInspector]
        ...
        [HideInInspector]
        public InvokePoseGrabable ActiveGrabPoint;
        [HideInInspector]
        public InvokePoseGrabable DesActiveGrabPoint;
        ...
        public virtual void UpdatePhysicsJoints() {
            ...
            if (GrabMechanic == GrabType.Snap) {
                ...
                Debug.Log("configurado como snap");
            }
                ...
                // Snap - Hand Models if close enough
                    ...
                    if (CanBeMoved) {
                        ...
                        if (distance < 0.001f ) {
                            // Snap position
                            parentHandGraphics(g);
                             Debug.Log("puede ser movido");

                            // Snap Hand Model Position
                            if (g.HandsGraphics != null) {
                                Debug.Log("g.HandsGraphics diferentes a null");
                                g.HandsGraphics.localEulerAngles = Vector3.zero;
                                g.HandsGraphics.localPosition = g.handsGraphicsGrabberOffset;
                            }
                        }
                        ...
                        if (grabTransform != null && distance < 0.1f) {
                            ...
                            positionHandGraphics(g); 
                             ...
                             Debug.Log("Can't be moved so go ahead and snap");
        ...
        public virtual void GrabItem(Grabber grabbedBy) {
            ...
            if (isPrimaryGrab) {
                ...
                if (primaryGrabOffset) {
                   ...
                   ActiveGrabPoint = primaryGrabOffset.GetComponent<InvokePoseGrabable>();
                }
                else {
                ...
                if (primaryGrabOffset != null && ActiveGrabPoint != null) {
                     ...
                     ActiveGrabPoint.AplicarPose();
                   //  Debug.Log("Probar la pose aqui");
                }
                else {
                   
                     Debug.Log("o sera Probar la pose aqui");
                }
                ...
                grabTransformSecondary.parent = grabbedBy.transform;
                 Debug.Log("Usando secundario graber");
        ...
        public virtual void DropItem(Grabber droppedBy, bool resetVelocity, bool resetParent) {
            ...
            if(isPrimaryGrabber) {
                ...
                UnsubscribeFromMoveEvents();
                 ...
                 DesActiveGrabPoint = primaryGrabOffset.GetComponent<InvokePoseGrabable>();
                 DesActiveGrabPoint.OnrelasePose();
                ...
                if(releaseItem) {
                    ...
                    if (rigid && resetVelocity && droppedBy && AddControllerVelocityOnDrop&& GrabPhysics != GrabPhysics.None) {
                        ...
                        Vector3 velocity =  droppedBy.GetComponent<Rigidbody>().linearVelocity;
                        Vector3 angularVelocity =  droppedBy.GetComponent<Rigidbody>().angularVelocity;
            ...
            if(GrabPoints != null) {
                ...
                for (int x = 0; x < grabCount; x++) {
                    ...
                    if (thisDist <= lastDistance) {
                        ...
                        InvokePoseGrabable gp = g.GetComponent<InvokePoseGrabable>();
                        if (gp) {
        ...
        /// </summary>
        /// <returns></returns>
       public virtual NewPlayerController GetBNGPlayerController() {
            ...
            if (GameObject.FindGameObjectWithTag("Player")) {
                return _player = GameObject.FindGameObjectWithTag("Player").GetComponentInChildren<NewPlayerController>();
            }
            else {
                return _player = FindFirstObjectByType<NewPlayerController>();
            }
        }
        ...
        public virtual void SubscribeToMoveEvents() {
           ...
           // PlayerTeleport.OnAfterTeleport += UnlockGrabbable;
            ...
            if(GrabPhysics == GrabPhysics.Velocity || GrabPhysics == GrabPhysics.PhysicsJoint) {
                ...
                AlcSmoothLocomotion.OnBeforeMove += LockGrabbable;
                AlcSmoothLocomotion.OnAfterMove += UnlockGrabbable;
            ...
            if (GrabPhysics == GrabPhysics.Kinematic && ParentToHands == true) {
                ...
                AlcSmoothLocomotion.OnBeforeMove += LockGrabbableWithRotation;
                AlcSmoothLocomotion.OnAfterMove += UnlockGrabbable;
            }
